                        ...
                        <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                            <AnimatedGroup variants={transitionVariants}>
                                <Link
                                    ...
                                    <span className="text-foreground text-sm">Introducing NFT-Based Ticketing</span>
                                ...
                                <h1
                                    ...
                                    Ticketing. Owned, fair, and fraud-proof.
                                </h1>
                                <p
                                    className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                                    Transparent ticket sales with programmable resale limits and fraud prevention — all without sacrificing user experience.
                                </p>
                            </AnimatedGroup>
                        ...
                        <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                            ...
                            <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                <img
                                    ...
                                    src="https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=2700&h=1440&fit=crop&crop=center"
                                    alt="app screen"
                                    width="2700"
                                    height="1440"
                                />
                    ...
                    <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
                        <div className="flex">
                            <img
                                ...
                                src="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=120&h=20&fit=crop&crop=center"
                                alt="Nvidia Logo"
                                height="20"
                                width="auto"
                            />
                        ...
                        <div className="flex">
                            <img
                                ...
                                src="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=120&h=16&fit=crop&crop=center"
                                alt="Column Logo"
                                height="16"
                                width="auto"
                            />
                        ...
                        <div className="flex">
                            <img
                                ...
                                src="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=120&h=28&fit=crop&crop=center"
                                alt="Lilly Logo"
                                height="28"
                                width="auto"
                            />
                        ...
                        <div className="flex">
                            <img
                                ...
                                src="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=120&h=24&fit=crop&crop=center"
                                alt="OpenAI Logo"
                                height="24"
                                width="auto"
                            />
